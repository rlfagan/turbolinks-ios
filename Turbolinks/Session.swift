...
extension Session: WKNavigationDelegate {
    ...
    fileprivate struct NavigationDecision {
        ...
        var externallyOpenableURL: URL? {
            if isModal {
                return nil
            } else if let URL = navigationAction.request.url, shouldOpenURLExternally || isPDF {
                return URL
            } else {
                return nil
            }
        ...
        var isPDF: Bool {
            ...
            if ((url?.absoluteString.contains(".pdf")) != nil) {
                return true
            } else {
                return false
            }
        ...
        var isModal: Bool {
            let url = navigationAction.request.url
            if ((url?.absoluteString.contains("#modal")) != nil) {
                return true
            } else {
                return false
            }
